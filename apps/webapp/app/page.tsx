      ...
      <div className="relative z-10 container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-screen gap-12">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-2xl mx-auto">
            Get ready for the next evolution in blockchain gaming. Join thousands of players in shaping the future of
            gaming.
          </p>
        ...
        >
          {[
            ...
            <Button key={i} variant="ghost" size="icon" className="text-gray-400 hover:text-white hover:bg-white/10">
