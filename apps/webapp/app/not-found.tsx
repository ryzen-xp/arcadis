  ...
  return (
    <PageWrapper>
      <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-screen gap-12">
        <h1 className="text-white font-semibold text-4xl mb-4">404 - Página no encontrada</h1>
        <p className="text-white/70 text-lg mb-8">Lo sentimos, la página que buscas no existe.</p>
        <Link 
          href="/" 
