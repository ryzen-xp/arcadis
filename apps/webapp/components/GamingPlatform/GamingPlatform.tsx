    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#1A2B3C] via-[#0A1525] to-[#070B1A] p-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-gray-300 max-w-3xl mx-auto mb-16 leading-relaxed">
          At StarkPlay Hub, we bridge the gap between players seeking immersive
          experiences and developers aiming to showcase their creations. Our
          platform is designed to cater to the needs of both communities,
          fostering a thriving ecosystem where everyone benefits.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-b from-[#0A1931] to-[#0A1525] backdrop-blur rounded-lg p-8 text-left flex flex-col items-center ">
            ...
            <p className="text-gray-300 text-sm mb-6 text-center leading-relaxed">
              Explore a library of Arcadis-based games, Engage in quests, write
              reviews, and participate in community votes to earn tokens, NFTs,
            ...
            <button className="text-gray-300 flex items-center hover:text-white transition-colors">
              Learn More
          ...
          <div className="bg-gradient-to-b from-[#0C1935] to-[#0A1525] backdrop-blur rounded-lg p-8 text-left flex flex-col items-center ">
            ...
            <p className="text-gray-300 text-sm mb-6 leading-relaxed text-center">
              List your Arcadis-based game to gain visibility, Receive valuable
              insights from player reviews and ratings to refine your game
            </p>
            <ul className="space-y-3 mb-8 w-full">
              {[
                "Showcase Your Game",
