...
export default function AwardCard({ type, name, category, icon }: AwardCardProps) {
  return (
    <>
        <div className={`rounded-full w-[3rem] h-[3rem] flex justify-center items-center p-2 mr-3 bg-gradient-to-r ${icon === 'trophy' ? 'from-[#FACC15] to-[#D97706]' : 'from-[#60A5FA] to-[#4F46E5]'}`}>
          {icon === 'trophy' ? (
